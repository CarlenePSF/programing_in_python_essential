...
# ele ignora, por definicao, esses valores repetidos sem gerar erro
print(s)
print(type(s))
...
# Importante tambem lembrar que alem de nao ter valores duplicados,
# tambem nao existe ordenamento num conjunto
...
# Observe que dicionarios e conjuntos nao aceitam chaves/elementos duplicados,
# respectivamente
